package umaru.bleachuhc.abilities.items;
...
import umaru.bleachuhc.bleachuhc.game.task.BreakIceCageTask;
...
public class IceCage {
    ...
    public static void iceCage(Location loc) {
        ...
        BukkitTask breakIceCageTask = new BreakIceCageTask(BleachUHC.getPlugin()).runTaskTimer(BleachUHC.getPlugin(), 0, 20);
    }
