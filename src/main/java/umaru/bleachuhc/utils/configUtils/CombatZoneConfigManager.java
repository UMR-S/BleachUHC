package umaru.bleachuhc.utils.configUtils;
...
public class CombatZoneConfigManager {
    ...
    public CombatZoneConfigManager(BleachUHC bleachUHC){
    ...
    public void reloadCombatZoneConfig(){
        if(this.fileCombatZoneConfig == null){
            this.fileCombatZoneConfig = new File(this.bleachUHC.getDataFolder(), "combatZoneConfig.yml");
        }
        this.dataCombatZoneConfig = YamlConfiguration.loadConfiguration(this.fileCombatZoneConfig);
        InputStream defaultStream = this.bleachUHC.getResource("combatZoneConfig.yml");
    ...
    public void saveCombatZoneConfig(){
        ...
        try {
            ...
            bleachUHC.getLogger().log(Level.SEVERE, "Could not save config to " + this.fileCombatZoneConfig, e);
        }
    }
    public void saveCombatZoneDefaultConfig(){
        System.out.println(this.fileCombatZoneConfig == null);
        if(this.fileCombatZoneConfig == null){
            this.fileCombatZoneConfig = new File(this.bleachUHC.getDataFolder(), "combatZoneConfig.yml");
        }
        if(!this.fileCombatZoneConfig.exists()){
            this.bleachUHC.saveResource("combatZoneConfig.yml", false);
        }
    }
    ...
    public void restoreCombatZone(){
        ...
        BleachUHC.combatzoneUtils.setAllZones(allCombatZones);
    }
}
